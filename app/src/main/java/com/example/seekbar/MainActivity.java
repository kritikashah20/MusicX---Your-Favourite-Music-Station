...
public class MainActivity extends AppCompatActivity {
    ...
    public void next(View view) {
        Intent intent = new Intent(this, badliar.class);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toast.makeText(this, "Click on Play to start the song!!", Toast.LENGTH_LONG).show();

        player = MediaPlayer.create(this , R.raw.music_tere);
